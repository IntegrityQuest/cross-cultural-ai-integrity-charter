                    ...
                    <h1 class="page-title">
                        <?php if($content_banner !=''){
                           echo esc_html($content_banner);
                                ...
                                if(!empty($perceptron_option['blog_title'])) { ?>
                                    <?php echo esc_html($perceptron_option['blog_title']);?>
                                    <?php }
                                    else{
                                     esc_html_e('Blog','perceptron');
                                } 
                            }
                        ?>
                    </h1>
...
<?php }
    elseif(!empty($perceptron_option['blog_banner_main']['url'])) { ?>
