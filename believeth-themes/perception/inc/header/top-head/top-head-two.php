                ...
                <div class="col-md-8">
                  <div class="toolbar-contact">
                    <ul class="rs-contact-info">                        
                        ...
                        <?php if(!empty($perceptron_option['top-location'])) { ?>              
                        <li class="rs-contact-location">
                          <i class="fa flaticon-location"></i> 
                          <span class="contact-inf">
                            <span><?php if(!empty($perceptron_option['location-pretext'])): echo esc_html($perceptron_option['location-pretext']); endif;?> </span>
                           <?php echo esc_html($perceptron_option['top-location'])?>
                          </span>
                        </li>
                      <?php } ?>
                  </ul>
