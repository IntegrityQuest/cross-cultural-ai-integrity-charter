...
?>
<?php if(!empty($perceptron_option['show-top'])){ 
  if(is_page()){
        ...
        <div class="row">
          <div class="col-lg-6 col-sm-7 col-xs-12">
            <div class="toolbar-contact">
              <ul>
                <?php if(!empty($perceptron_option['welcome-text'])) { ?>
                <li> <i class="fa fa-handshake-o"></i> <?php echo esc_html($perceptron_option['welcome-text']); ?> </li>
                <?php } ?>
                <?php if(!empty($perceptron_option['top-email'])) { ?>
                <li> <i class="fa fa-envelope-o"></i><a href="mailto:<?php echo esc_attr($perceptron_option['top-email'])?>"><?php echo esc_html($perceptron_option['top-email'])?></a> </li>
                <?php } ?>
              </ul>
            </div>
          </div>
