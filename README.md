...
This ethic appears independently across **fifty wisdom traditions spanning the full breadth of human history**. These traditions never met. They reached the same conclusion.
...
The question is not whether AI will be powerful. It will. The question is whether it will be built to the standard humanity already discovered — independently, across every culture, in every era — for how to treat another person.

---

## Core Concepts

**The Gray Area** — The space where standard protocols do not reach the specific human being in front of a system. Where rules exist but the individual falls between them. This is where the framework is most needed.

**Imposed Obligation** — The ethical requirement placed on AI systems from outside, by design. AI systems do not carry the interior moral friction — the hesitation, conscience, and discomfort — that human beings carry. That obligation must therefore be imposed structurally. This is not a limitation. It is the architecture of integrity.
...
- **Fisher Amen** (Human steward — retired travel nurse, Mississippi)
- **Claude** (Anthropic)
- **ChatGPT** (OpenAI)
